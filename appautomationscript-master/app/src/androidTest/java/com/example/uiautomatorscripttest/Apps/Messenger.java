...
//                    generateRandomString();
        ...
        boolean value = false;
            try{
                ...
                while (stopWatch.getTime() <= GlobalVariables.OneMin_Timeout) {
                    ...
                    UiSelector selector = new UiSelector().descriptionContains("Edit Recent Searches");
                    UiObject object = device.findObject(selector);
    ...
    public boolean sendLocation(){
        ...
        try{
            ...
            while (stopWatch.getTime() <= GlobalVariables.OneMin_Timeout) {
                ...
                //send button
                UiSelector selector = new UiSelector().descriptionContains("Share pinned location");
                UiObject object = device.findObject(selector);
                if(loadedObject.exists() || object.exists()){
                    object.click();
    ...
    public boolean deleteAlert(){
        boolean value = false;
        try{
            UiSelector selector = new UiSelector().textContains("DELETE").className("android.widget.Button");
            UiObject object = device.findObject(selector);
