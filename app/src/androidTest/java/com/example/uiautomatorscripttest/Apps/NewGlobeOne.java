    ...
    private boolean homeElement() {
        ...
        try {
            ...
            while (stopWatch.getTime() <= GlobalVariables.OneMin_Timeout) {
                ...
                UiSelector homeElementId = new UiSelector().resourceId("ph.co   m.globe.globeonesuperapp:id/iv_user");
    ...
    private boolean gotoShop() {
        ...
        try {
            ...
            while (stopWatch.getTime() <= GlobalVariables.OneMin_Timeout) {
                ...
                UiSelector secSelector = new UiSelector().textContains("Buy");
                UiObject secObject = device.findObject(secSelector);
                if (secObject.exists()) {
                    secObject.click();
    ...
    private boolean shopDisplayed() {
        ...
        try {
            ...
            while (stopWatch.getTime() <= GlobalVariables.OneMin_Timeout) {
                ...
                UiSelector selectAccount = new UiSelector().resourceId("ph.com.globe.globeonesuperapp:id/btn_choose_account");
                UiObject objectAccount = device.findObject(selectAccount);
                objectAccount.click();
    ...
    private boolean gotoHelpAndSupport() {
        ...
        try {
            ...
            while (stopWatch.getTime() <= GlobalVariables.OneMin_Timeout) {
                ...
                UiSelector selectMore = new UiSelector().resourceId("ph.com.globe.globeonesuperapp:id/discover_subgraph");
                UiObject objectMore = device.findObject(selectMore);
                objectMore.click();

                UiSelector firstSelector = new UiSelector().resourceId("ph.com.globe.globeonesuperapp:id/tv_help");
                UiObject firstObject = device.findObject(firstSelector);
